$(function () {
    showNav()
    animateCSS("#banner", "slideInDown");

    // $("#banner").on('transitionend webkitTransitionEnd oTransitionEnd otransitionend MSTransitionEnd', function() {
    //     console.log("done");
    //     $('#banner').css('display', 'none');
        // $("#banner").style.display = "none";
        // $('#banner').addClass("gone")
        // animateCSS(".navbar", "slideOutUp", true);
...
function showNav() {
    $("#banner").removeClass("is-hidden").addClass("is-visible");
};
